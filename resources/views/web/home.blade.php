...
>
  <div class="max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
    <h1 class="text-3xl font-extrabold sm:text-5xl text-neutral-700">
      The Best Field With The Best Coach
      <strong class="block font-extrabold text-pink-500">
        Balige Sport.      </strong>
    </h1>

    <p class="mt-4 max-w-lg sm:text-xl/relaxed">
    Badminton Court With The Best Booking Process
         </p>
 ...
 <div>
    ...
    <div class="container flex gap-10 p-10 pt-3 justify-center mx-auto">
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
          <img class="w-60 rounded-xl" src="{{ asset('images/lapanganb.jpg')}}" alt="">
          <span class="text-pink-500 text-2xl">Field</span>
      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/BOLA.jpg')}}"  alt="">
        <span class="text-pink-500 text-2xl">Ball</span>

      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/raket.jpeg')}}" alt="">
        <span class="text-pink-500 text-2xl">Racket</span>

      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/room1.jpeg')}}" alt="">
            ...
            <div class="flex w-1/3 flex-wrap">
              <div class="w-full p-1 md:p-2">
                <img
                  ...
                  src="images/gallery/lapangan1 (1).jpeg" />
              </div>
            </div>
            <div class="flex w-1/3 flex-wrap">
              <div class="w-full p-1 md:p-2">
                <img
                  alt="gallery"
                  class="block h-full w-full rounded-lg object-cover object-center"
                  src="images/gallery/lapangan1 (1).jpg" />
              </div>
            </div>
            <div class="flex w-1/3 flex-wrap">
              <div class="w-full p-1 md:p-2">
                <img
                  alt="gallery"
                  class="block h-full w-full rounded-lg object-cover object-center"
                  src="images/gallery/lapangan1 (2).jpeg" />
              </div>
            </div>
            <div class="flex w-1/3 flex-wrap">
              <div class="w-full p-1 md:p-2">
                <img
                  alt="gallery"
                  class="block h-full w-full rounded-lg object-cover object-center"
                  src="images/gallery/lapangan1(2).jpg" />
              </div>
            </div>
            <div class="flex w-1/3 flex-wrap">
              <div class="w-full p-1 md:p-2">
                <img
                  alt="gallery"
                  class="block h-full w-full rounded-lg object-cover object-center"
                  src="images/gallery/lapangan.jpg" />
              </div>
            </div>
            <div class="flex w-1/3 flex-wrap">
              <div class="w-full p-1 md:p-2">
                <img
                  alt="gallery"
                  class="block h-full w-full rounded-lg object-cover object-center"
                  src="images/gallery/lapanganb.jpg" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid gap-6 text-center p-6 md:grid-cols-3 lg:gap-12">
          <div class="mb-12 md:mb-0">
            <div class="mb-6 flex justify-center">
              <img src="hizkia.jpg" class="w-32 rounded-full shadow-lg dark:shadow-black/30">
            </div>
            <h5 class="mb-4 text-xl font-semibold">Hizkia Sipayung</h5>
            ...
            <p class="mb-4 text-neutral-500">
              ...
              "I had the most amazing experience at Balige Sport! The staff is very friendly and welcoming, and my body looks very healthy and fit!"
            </p>
          ...
          <div class="mb-12 md:mb-0">
            <div class="mb-6 flex justify-center">
              <img src="bedu.jpg" class="w-32 rounded-full shadow-lg dark:shadow-black/30">
            </div>
            <h5 class="mb-4 text-xl font-semibold">Bedu Sicoy</h5>
            <h6 class="mb-4 font-semibold text-primary dark:text-primary-400">
              Graphic Designer
            </h6>
            <p class="mb-4 text-neutral-500">
              ...
              "I had the best experience of my life at Balige Sport! The trainer listened to exactly what I wanted and then gave me a training that exceeded my expectations!"
            </p>
            <ul class="mb-0 flex items-center justify-center">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-500">
          ...
          <div class="mb-0">
            <div class="mb-6 flex justify-center">
              <img src="matteo.jpg" class="w-32 rounded-full shadow-lg dark:shadow-black/30">
            </div>
            <h5 class="mb-4 text-xl font-semibold">Matteo Hoppskins</h5>
            <h6 class="mb-4 font-semibold text-primary dark:text-primary-400">
            ...
            <p class="mb-4 text-neutral-500">
             ...
             "I had a last minute emergency and Balige Sport came to the rescue! The staff were able to fit me in immediately and they did an amazing job. And they are very professional."
            </p>
            <ul class="mb-0 flex items-center justify-center">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-500">
  ...
  <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
    ...
    <div>
      <h6
        ...
        <img class="w-10 h-10" src="{{ asset('images/badminku.jpg')}}" alt="">
        Balige Sport
    </h6>
